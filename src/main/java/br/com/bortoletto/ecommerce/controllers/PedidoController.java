...
import br.com.bortoletto.ecommerce.entities.factory.DecoratorFactory;
...
public class PedidoController implements Serializable {
	...
	public void adicionarCarrinho() {
		setMassaSelecionada(DecoratorFactory.decoratorPasta(criarIterator(), getMassaSelecionada()));
		System.out.println(getMassaSelecionada());
	}
